...
- [Filtering](docs/conventions/FILTERING.md) — data-access query contracts: `FilterParams`, lookups, `FilterSet`
- [Pagination](docs/conventions/PAGINATION.md) — HTTP contract of list endpoints and unified pagination meta
